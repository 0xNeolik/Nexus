...
// function editMapDetails() {
//   let map = new google.maps.Map(document.getElementById("editMapDetails"), {
//     center: { lat: 40, lng: -3 },
//     zoom: 13,
//   });

//   let input = document.getElementById("searchInputEdit");
//   map.controls[google.maps.ControlPosition.TOP_LEFT].push(input);
...
//   cyberMarkers(map, mapLatitude, mapLongitude)
// };